        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
              ...
              <form action="_inserir_cadnota.php" method="post" style="margin: 20px 20px 0px 20px">
                ...
                <div class="col" style="margin: 20px 0 40px 20px">
                  <h6 style="color: red">
                    Total Líquido
                    <small class="text-muted">Conferir com a nota de corretagem.</small>
                    <input type="text" class="form-control" style="width: 100px" name="tLiquido" id="tLiquido">
                  </h6>
                </div>
            </div>

            <div style="text-align: right; margin: 0 15px 20px 0">
              <input class="btn btn-info btn-sm" type="button" value="Calcular" id="btnCalc">
              <button type="submit" class="btn btn-primary btn-sm">Cadastrar</button>
              <a href="index.html" role="button" class="btn btn-danger btn-sm">Voltar</a>
            </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5>
                Negócios Realizados
                <small class="text-muted"> - Inserira as operações da Nota de Corretagem</small>
              </h5>
              ...
              <div style="margin: 20px 20px 0px 20px">
                <div class="form-row">
                  <div class="col-md-2">
                    <label>Operação</label>
                    <select class="form-control" style="color: orange" name="operacao" id="operacao">
                  ...
                  <div class="col-md-2">
                    <label>Papel</label>
                    <select class="form-control" style="color: orange" name="papel" id="papel">
                      <option selected>Selecione</option>
                      <option>Opção</option>
                      <option>Ação</option>
                      <option>ETF</option>
                  ...
                  <div class="col1">
                    <input class="btn btn-primary btn-sm btnAddRow" type="button" nome="btnAddRow" id="btnAddRow" value="ADD">
                  </div>
              ...
              <!-- Tabela -->
              <div class="card" style="background-color: #00000094">
                <div class="card-body">
              ...
              <div style="text-align: right; margin-top:1px">
                <input class="btn btn-info btn-sm" type="button" nome="btnCalcTx" id="btnCalcTx" value="Calcular Taxas">
                <button type="submit" class="btn btn-primary btn-sm">Cadastrar</button>
                <a href="index.html" role="button" class="btn btn-danger btn-sm">Voltar</a>
              </div>
